...
对照 `.Codex/conventions/layout-spacing-system.md` 规范，检查 HTML/CSS 文件是否合规。3 步流程：读取规范 → 逐项检查 → 输出报告。
...
- 规范文件 `.Codex/conventions/layout-spacing-system.md` 必须存在
...
1. 读取 `.Codex/conventions/layout-spacing-system.md` 并提取全部 9 条规则
