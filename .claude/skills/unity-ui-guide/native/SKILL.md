---
name: unity-ui-guide-native
description: "[Native/UGUI] Unity UI 组件参数详解与创建规范——Canvas、CanvasScaler、GraphicRaycaster、Image、Button、TextMeshPro、Slider、Toggle、Dropdown、InputField、ScrollRect 等全部 UI 组件的参数说明与最佳实践。Use when 需要创建/修改 Unity UGUI UI、排查 UI 不显示/不可交互问题、或需要参考 UI 组件参数。"
---

# Unity UI 组件参数详解与创建规范 — Native (UGUI)
